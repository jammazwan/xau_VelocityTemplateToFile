...
so you can focus only on what is required to demo the **VelocityTemplateToFile** feature **_in isolation_**.
...
The prefix **xau** is used for maintaining sort order in a directory, providing packaging, and is otherwise meaningless. The x stands for _example_.
